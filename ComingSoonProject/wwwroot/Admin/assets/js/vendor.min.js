!function (e, t) {
    ...
    var p = function (n) {
        var e, h, _, o, r, p, f, g, w, l, u, E, T, s, x, m, a, c, v, C = "sizzle" + 1 * new Date, y = n.document, S = 0,
            ...
            Q = new RegExp(R + "|>"), V = new RegExp(W), $ = new RegExp("^" + q + "$"), K = {
                ID: new RegExp("^#(" + q + ")"),
                CLASS: new RegExp("^\\.(" + q + ")"),
                TAG: new RegExp("^(" + q + "|[*])"),
                ATTR: new RegExp("^" + M),
        ...
        for (e in h = ae.support = {}, r = ae.isXML = function (e) {
            ...
            pseudos: {
                not: ue(function (e) {
                    ...
                    return $.test(n || "") || ae.error("unsupported lang: " + n), n = n.replace(te, ne).toLowerCase(), function (e) {
                        var t;
                        do {
        ...
        return ye.prototype = _.filters = _.pseudos, _.setFilters = new ye, p = ae.tokenize = function (e, t) {
            ...
            if (n = n || [], 1 === c.length) {
                ...
                for (r = K.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !_.relative[a = s.type]);) if ((l = _.find[a]) && (i = l(s.matches[0].replace(te, ne), ee.test(o[0].type) && ve(t.parentNode) || t))) {
    ...
    function $(e) {
        return e.replace(z, "ms-").replace(Q, V)
    }
    ...
    C.extend({
        ...
        data: function (n, e) {
            ...
            if (this.length && (r = G.get(o), 1 === o.nodeType && !X.get(o, "hasDataAttrs"))) {
                for (t = s.length; t--;) s[t] && 0 === (i = s[t].name).indexOf("data-") && (i = $(i.slice(5)), ee(o, i, r[i]));
    ...
    C.event = {
        global: {}, add: function (t, e, n, i, r) {
            ...
            if (m && (l = m.events)) {
                for (u = (t = (t || "").match(P) || [""]).length; u--;) if (h = g = (a = xe.exec(t[u]) || [])[1], p = (a[2] || "").split(".").sort(), h) {
    ...
    C.extend({
        htmlPrefilter: function (e) {
            ...
            for (var t, n, i, r = C.event.special, o = 0; void 0 !== (n = e[o]); o++) if (K(n)) {
                if (t = n[X.expando]) {
    ...
    var Qe = ["Webkit", "Moz", "ms"], Ve = x.createElement("div").style, $e = {};
    ...
    C.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = $(t), l = Xe.test(t), u = e.style;
                if (l || (t = Ke(a)), s = C.cssHooks[t] || C.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : u[t];
        ...
        css: function (e, t, n, i) {
            var r, o, s, a = $(t);
            return Xe.test(t) || (t = Ke(a)), (s = C.cssHooks[t] || C.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = Ue(e, t, i)), "normal" === r && t in Je && (r = Je[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    ...
    C.extend(C.event, {
        trigger: function (e, t, n, i) {
            ...
            if (o = f = s = n = n || x, 3 !== n.nodeType && 8 !== n.nodeType && !Et.test(h + C.event.triggered) && (-1 < h.indexOf(".") && (h = (p = h.split(".")).shift(), p.sort()), l = h.indexOf(":") < 0 && "on" + h, (e = e[C.expando] ? e : new C.Event(h, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), c = C.event.special[h] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                ...
                for (r = 0; (o = d[r++]) && !e.isPropagationStopped();) f = o, e.type = 1 < r ? a : c.bindType || h, (u = (X.get(o, "events") || {})[e.type] && X.get(o, "handle")) && u.apply(o, t), (u = l && o[l]) && u.apply && K(o) && (e.result = u.apply(o, t), !1 === e.result && e.preventDefault());
                return e.type = h, i || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(d.pop(), t) || !K(n) || l && y(n[h]) && !b(n) && ((s = n[l]) && (n[l] = null), C.event.triggered = h, e.isPropagationStopped() && f.addEventListener(h, Tt), n[h](), e.isPropagationStopped() && f.removeEventListener(h, Tt), C.event.triggered = void 0, s && (n[l] = s)), e.result
            }
    ...
    function kt(n, e, i, r) {
        ...
        }); else if (i || "object" !== w(e)) r(n, e); else for (t in e) kt(n + "[" + t + "]", e[t], i, r)
    }
    ...
    var Qt = {0: 200, 1223: 204}, Vt = C.ajaxSettings.xhr();
    v.cors = !!Vt && "withCredentials" in Vt, v.ajax = Vt = !!Vt, C.ajaxTransport(function (r) {
        var o, s;
        if (v.cors || Vt && !r.crossDomain) return {
            send: function (e, t) {
                var n, i = r.xhr();
    ...
    C.ajaxSetup({
        ...
        if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Yt, "$1" + i) : !1 !== e.jsonp && (e.url += (St.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function () {
            ...
            void 0 === r ? C(T).removeProp(i) : T[i] = r, e[i] && (e.jsonpCallback = t.jsonpCallback, Kt.push(i)), o && y(r) && r(o[0]), o = r = void 0
        }), "script"
    }), v.createHTMLDocument = (($t = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === $t.childNodes.length), C.parseHTML = function (e, t, n) {
    ...
    }, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = D, C.isFunction = y, C.isWindow = b, C.camelCase = $, C.type = w, C.now = Date.now, C.isNumeric = function (e) {
        var t = C.type(e);
    ...
    var o = "alert", a = "bs.alert", u = "." + a, c = p.fn[o],
        f = {CLOSE: "close" + u, CLOSED: "closed" + u, CLICK_DATA_API: "click" + u + ".data-api"}, d = "alert",
        h = "fade", m = "show", v = function () {
            function i(e) {
                this._element = e
            }
    ...
    p(document).on(f.CLICK_DATA_API, '[data-dismiss="alert"]', v._handleDismiss(new v)), p.fn[o] = v._jQueryInterface, p.fn[o].Constructor = v, p.fn[o].noConflict = function () {
        return p.fn[o] = c, v._jQueryInterface
    };
    var y = "button", b = "bs.button", _ = "." + b, w = ".data-api", E = p.fn[y], T = "active", x = "btn", C = "focus",
        S = '[data-toggle^="button"]', A = '[data-toggle="buttons"]', D = '[data-toggle="button"]',
        N = '[data-toggle="buttons"] .btn', I = 'input:not([type="hidden"])', k = ".active", O = ".btn", L = {
            CLICK_DATA_API: "click" + _ + w,
            FOCUS_BLUR_DATA_API: "focus" + _ + w + " blur" + _ + w,
            LOAD_DATA_API: "load" + _ + w
        }, j = function () {
            function n(e) {
                this._element = e
            }
    ...
    p(document).on(L.CLICK_DATA_API, S, function (e) {
        var t = e.target;
        if (p(t).hasClass(x) || (t = p(t).closest(O)[0]), !t || t.hasAttribute("disabled") || t.classList.contains("disabled")) e.preventDefault(); else {
            var n = t.querySelector(I);
            if (n && (n.hasAttribute("disabled") || n.classList.contains("disabled"))) return void e.preventDefault();
            j._jQueryInterface.call(p(t), "toggle")
        }
    }).on(L.FOCUS_BLUR_DATA_API, S, function (e) {
        var t = p(e.target).closest(O)[0];
        p(t).toggleClass(C, /^focus(in)?$/.test(e.type))
    }), p(window).on(L.LOAD_DATA_API, function () {
        for (var e = [].slice.call(document.querySelectorAll(N)), t = 0, n = e.length; t < n; t++) {
            var i = e[t], r = i.querySelector(I);
            r.checked || r.hasAttribute("checked") ? i.classList.add(T) : i.classList.remove(T)
        }
        for (var o = 0, s = (e = [].slice.call(document.querySelectorAll(D))).length; o < s; o++) {
            var a = e[o];
            "true" === a.getAttribute("aria-pressed") ? a.classList.add(T) : a.classList.remove(T)
        }
    }), p.fn[y] = j._jQueryInterface, p.fn[y].Constructor = j, p.fn[y].noConflict = function () {
        return p.fn[y] = E, j._jQueryInterface
    };
    var H = "carousel", P = "bs.carousel", R = "." + P, q = ".data-api", M = p.fn[H],
        W = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, F = {
            ...
            wrap: "boolean",
            touch: "boolean"
        }, B = "next", U = "prev", z = "left", Q = "right", V = {
            SLIDE: "slide" + R,
            SLID: "slid" + R,
            KEYDOWN: "keydown" + R,
            ...
            LOAD_DATA_API: "load" + R + q,
            CLICK_DATA_API: "click" + R + q
        }, $ = "carousel", K = "active", Y = "slide", X = "carousel-item-right", G = "carousel-item-left",
        J = "carousel-item-next", Z = "carousel-item-prev", ee = "pointer-event", te = ".active",
        ne = ".active.carousel-item", ie = ".carousel-item", re = ".carousel-item img",
        oe = ".carousel-item-next, .carousel-item-prev", se = ".carousel-indicators",
        ae = "[data-slide], [data-slide-to]", le = '[data-ride="carousel"]', ue = {TOUCH: "touch", PEN: "pen"},
        ce = function () {
            function o(e, t) {
            ...
            return e.next = function () {
                ...
                e || (this._isPaused = !0), this._element.querySelector(oe) && (g.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
            }, e.cycle = function (e) {
                ...
                p(this._element).off(R), p.removeData(this._element, P), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, e._getConfig = function (e) {
                return e = l({}, W, {}, e), g.typeCheckConfig(H, e, F), e
                ...
                if (this._touchSupported) {
                    var t = function (e) {
                        n._pointerEvent && ue[e.originalEvent.pointerType.toUpperCase()] ? n.touchStartX = e.originalEvent.clientX : n._pointerEvent || (n.touchStartX = e.originalEvent.touches[0].clientX)
                    }, i = function (e) {
                        n._pointerEvent && ue[e.originalEvent.pointerType.toUpperCase()] && (n.touchDeltaX = e.originalEvent.clientX - n.touchStartX), n._handleSwipe(), "hover" === n._config.pause && (n.pause(), n.touchTimeout && clearTimeout(n.touchTimeout), n.touchTimeout = setTimeout(function (e) {
                            return n.cycle(e)
                        }, 500 + n._config.interval))
                    };
                    p(this._element.querySelectorAll(re)).on(V.DRAG_START, function (e) {
                ...
                var n = e === B, i = e === U, r = this._getItemIndex(t), o = this._items.length - 1;
                ...
                var n = this._getItemIndex(e), i = this._getItemIndex(this._element.querySelector(ne)),
                    r = p.Event(V.SLIDE, {relatedTarget: e, direction: t, from: i, to: n});
                ...
                var n, i, r, o = this, s = this._element.querySelector(ne), a = this._getItemIndex(s),
                    l = t || s && this._getItemByDirection(e, s), u = this._getItemIndex(l),
                    c = Boolean(this._interval);
                if (r = e === B ? (n = G, i = J, z) : (n = X, i = Z, Q), l && p(l).hasClass(K)) this._isSliding = !1; else if (!this._triggerSlideEvent(l, r).isDefaultPrevented() && s && l) {
                    this._isSliding = !0, c && this.pause(), this._setActiveIndicatorElement(l);
                    var f = p.Event(V.SLID, {relatedTarget: l, direction: r, from: a, to: u});
                ...
                return this.each(function () {
                    var e = p(this).data(P), t = l({}, W, {}, p(this).data());
                    "object" == typeof i && (t = l({}, t, {}, i));
                    var n = "string" == typeof i ? i : t.slide;
                    if (e || (e = new o(this, t), p(this).data(P, e)), "number" == typeof i) e.to(i); else if ("string" == typeof n) {
                ...
                if (t) {
                    ...
                    if (n && p(n).hasClass($)) {
                        ...
                        r && (i.interval = !1), o._jQueryInterface.call(p(n), i), r && p(n).data(P).to(r), e.preventDefault()
                    }
                }
            }, s(o, null, [{
                key: "VERSION", get: function () {
    ...
    p(document).on(V.CLICK_DATA_API, ae, ce._dataApiClickHandler), p(window).on(V.LOAD_DATA_API, function () {
        for (var e = [].slice.call(document.querySelectorAll(le)), t = 0, n = e.length; t < n; t++) {
            var i = p(e[t]);
            ce._jQueryInterface.call(i, i.data())
        }
    }), p.fn[H] = ce._jQueryInterface, p.fn[H].Constructor = ce, p.fn[H].noConflict = function () {
        return p.fn[H] = M, ce._jQueryInterface
    };
    var fe = "collapse", de = "bs.collapse", he = "." + de, pe = p.fn[fe], ge = {toggle: !0, parent: ""},
        me = {toggle: "boolean", parent: "(string|element)"}, ve = {
            SHOW: "show" + he,
            SHOWN: "shown" + he,
            HIDE: "hide" + he,
            HIDDEN: "hidden" + he,
            CLICK_DATA_API: "click" + he + ".data-api"
        }, ye = "show", be = "collapse", _e = "collapsing", we = "collapsed", Ee = "width", Te = "height",
        xe = ".show, .collapsing", Ce = '[data-toggle="collapse"]', Se = function () {
            function a(t, e) {
            ...
            var e = a.prototype;
            return e.toggle = function () {
                p(this._element).hasClass(ye) ? this.hide() : this.show()
            }, e.show = function () {
                var e, t, n = this;
                if (!this._isTransitioning && !p(this._element).hasClass(ye) && (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(xe)).filter(function (e) {
                    return "string" == typeof n._config.parent ? e.getAttribute("data-parent") === n._config.parent : e.classList.contains(be)
                })).length && (e = null), !(e && (t = p(e).not(this._selector).data(de)) && t._isTransitioning))) {
                    var i = p.Event(ve.SHOW);
                    if (p(this._element).trigger(i), !i.isDefaultPrevented()) {
                        e && (a._jQueryInterface.call(p(e).not(this._selector), "hide"), t || p(e).data(de, null));
                        var r = this._getDimension();
                        p(this._element).removeClass(be).addClass(_e), this._element.style[r] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(we).attr("aria-expanded", !0), this.setTransitioning(!0);
                        var o = "scroll" + (r[0].toUpperCase() + r.slice(1)),
                            s = g.getTransitionDurationFromElement(this._element);
                        p(this._element).one(g.TRANSITION_END, function () {
                            p(n._element).removeClass(_e).addClass(be).addClass(ye), n._element.style[r] = "", n.setTransitioning(!1), p(n._element).trigger(ve.SHOWN)
                        }).emulateTransitionEnd(s), this._element.style[r] = this._element[o] + "px"
                    }
                }
            }, e.hide = function () {
                var e = this;
                if (!this._isTransitioning && p(this._element).hasClass(ye)) {
                    var t = p.Event(ve.HIDE);
                    if (p(this._element).trigger(t), !t.isDefaultPrevented()) {
                        var n = this._getDimension();
                        this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", g.reflow(this._element), p(this._element).addClass(_e).removeClass(be).removeClass(ye);
                        var i = this._triggerArray.length;
                        if (0 < i) for (var r = 0; r < i; r++) {
                            var o = this._triggerArray[r], s = g.getSelectorFromElement(o);
                            if (null !== s) p([].slice.call(document.querySelectorAll(s))).hasClass(ye) || p(o).addClass(we).attr("aria-expanded", !1)
                        }
                        this.setTransitioning(!0);
                        this._element.style[n] = "";
                        var a = g.getTransitionDurationFromElement(this._element);
                        p(this._element).one(g.TRANSITION_END, function () {
                            e.setTransitioning(!1), p(e._element).removeClass(_e).addClass(be).trigger(ve.HIDDEN)
                ...
                p.removeData(this._element, de), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
            }, e._getConfig = function (e) {
                return (e = l({}, ge, {}, e)).toggle = Boolean(e.toggle), g.typeCheckConfig(fe, e, me), e
            }, e._getDimension = function () {
                return p(this._element).hasClass(Ee) ? Ee : Te
                ...
                var n = p(e).hasClass(ye);
                t.length && p(t).toggleClass(we, !n).attr("aria-expanded", n)
            }, a._getTargetFromElement = function (e) {
                var t = g.getSelectorFromElement(e);
                return t ? document.querySelector(t) : null
            }, a._jQueryInterface = function (i) {
                return this.each(function () {
                    var e = p(this), t = e.data(de), n = l({}, ge, {}, e.data(), {}, "object" == typeof i && i ? i : {});
                    if (!t && n.toggle && /show|hide/.test(i) && (n.toggle = !1), t || (t = new a(this, n), e.data(de, t)), "string" == typeof i) {
    ...
    p(document).on(ve.CLICK_DATA_API, Ce, function (e) {
        "A" === e.currentTarget.tagName && e.preventDefault();
        var n = p(this), t = g.getSelectorFromElement(this), i = [].slice.call(document.querySelectorAll(t));
        p(i).each(function () {
            var e = p(this), t = e.data(de) ? "toggle" : n.data();
            Se._jQueryInterface.call(e, t)
        })
    }), p.fn[fe] = Se._jQueryInterface, p.fn[fe].Constructor = Se, p.fn[fe].noConflict = function () {
        return p.fn[fe] = pe, Se._jQueryInterface
    };
    var Ae = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator,
        De = function () {
            for (var e = ["Edge", "Trident", "Firefox"], t = 0; t < e.length; t += 1) if (Ae && 0 <= navigator.userAgent.indexOf(e[t])) return 1;
            return 0
        }();
    var Ne = Ae && window.Promise ? function (e) {
        var t = !1;
        return function () {
    ...
    function We(e, t) {
        ...
        var u = Me(e);
        return u.host ? We(u.host, t) : We(e, Me(t).host)
    }
    ...
    function ze(e) {
        ...
        return {height: Ue("Height", t, n, i), width: Ue("Width", t, n, i)}
    }
    ...
    function Ye(e) {
        ...
        var r = {left: t.left, top: t.top, width: t.right - t.left, height: t.bottom - t.top},
            o = "HTML" === e.nodeName ? ze(e.ownerDocument) : {}, s = o.width || e.clientWidth || r.width,
            a = o.height || e.clientHeight || r.height, l = e.offsetWidth - s, u = e.offsetHeight - a;
        if (l || u) {
            var c = ke(e);
            l -= Be(c, "x"), u -= Be(c, "y"), r.width -= l, r.height -= u
        }
        return Ke(r)
    }

    function Xe(e, t) {
        var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], i = Re(10), r = "HTML" === t.nodeName,
            o = Ye(e), s = Ye(t), a = Le(e), l = ke(t), u = parseFloat(l.borderTopWidth, 10),
            c = parseFloat(l.borderLeftWidth, 10);
        n && r && (s.top = Math.max(s.top, 0), s.left = Math.max(s.left, 0));
        var f = Ke({top: o.top - s.top - u, left: o.left - s.left - c, width: o.width, height: o.height});
        ...
        return (i && !n ? t.contains(a) : t === a && "BODY" !== a.nodeName) && (f = function (e, t) {
            var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], i = Fe(t, "top"),
                r = Fe(t, "left"), o = n ? -1 : 1;
    ...
    function Je(e, t, n, i) {
        ...
        if ("viewport" === i) o = function (e) {
            var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
                n = e.ownerDocument.documentElement, i = Xe(e, n), r = Math.max(n.clientWidth, window.innerWidth || 0),
                o = Math.max(n.clientHeight, window.innerHeight || 0), s = t ? 0 : Fe(n), a = t ? 0 : Fe(n, "left");
            return Ke({top: s - i.top + i.marginTop, left: a - i.left + i.marginLeft, width: r, height: o})
        }(s, r); else {
            var a = void 0;
            ...
            if ("HTML" !== a.nodeName || function e(t) {
                ...
                var u = ze(e.ownerDocument), c = u.height, f = u.width;
    ...
    function et(e, t, n) {
        ...
        return Xe(n, i ? Ge(t) : We(t, je(n)), i)
    }
    ...
    function it(e, t, n) {
        n = n.split("-")[0];
        var i = tt(e), r = {width: i.width, height: i.height}, o = -1 !== ["right", "left"].indexOf(n),
    ...
    function ot(e, n, t) {
        return (void 0 === t ? e : e.slice(0, function (e, t, n) {
            ...
            e.enabled && Ie(t) && (n.offsets.popper = Ke(n.offsets.popper), n.offsets.reference = Ke(n.offsets.reference), n = t(n, e))
        }), n
    }
    ...
    function ut(e, t, n, i) {
        n.updateBound = i, lt(e).addEventListener("resize", n.updateBound, {passive: !0});
        var r = Le(e);
        return function e(t, n, i, r) {
            var o = "BODY" === t.nodeName, s = o ? t.ownerDocument.defaultView : t;
            s.addEventListener(n, i, {passive: !0}), o || e(Le(s.parentNode), n, i, r), r.push(s)
        }(r, "scroll", n.updateBound, n.scrollParents), n.scrollElement = r, n.eventsEnabled = !0, n
    }

    function ct() {
        var e, t;
        this.state.eventsEnabled && (cancelAnimationFrame(this.scheduleUpdate), this.state = (e = this.reference, t = this.state, lt(e).removeEventListener("resize", t.updateBound), t.scrollParents.forEach(function (e) {
    ...
    var ht = Ae && /Firefox/i.test(navigator.userAgent);
    ...
    function vt(e) {
        var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], n = mt.indexOf(e),
            i = mt.slice(n + 1).concat(mt.slice(0, n));
        return t ? i.reverse() : i
    }

    var yt = "flip", bt = "clockwise", _t = "counterclockwise";
    ...
    var Et = {
        placement: "bottom", positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
            ...
            shift: {
                ...
                order: 200, enabled: !0, fn: function (e, t) {
                    ...
                    return l = ft(+n) ? [+n, 0] : wt(n, o, s, a), "left" === a ? (o.top += l[0], o.left -= l[1]) : "right" === a ? (o.top += l[0], o.left += l[1]) : "top" === a ? (o.left += l[0], o.top -= l[1]) : "bottom" === a && (o.left += l[0], o.top += l[1]), e.popper = o, e
                }, offset: 0
            }, preventOverflow: {
                order: 300, enabled: !0, fn: function (e, i) {
                    var t = i.boundariesElement || qe(e.instance.popper);
                    e.instance.reference === t && (t = qe(t));
                    var n = at("transform"), r = e.instance.popper.style, o = r.top, s = r.left, a = r[n];
                    r.top = "", r.left = "", r[n] = "";
                    ...
                    var u = i.priority, c = e.offsets.popper, f = {
                        primary: function (e) {
                            var t = c[e];
                            return c[e] < l[e] && !i.escapeWithReference && (t = Math.max(c[e], l[e])), Ve({}, e, t)
                        }, secondary: function (e) {
                            var t = "right" === e ? "left" : "top", n = c[t];
                            return c[e] > l[e] && !i.escapeWithReference && (n = Math.min(c[t], l[e] - ("right" === e ? c.width : c.height))), Ve({}, t, n)
                        }
                    };
                ...
                order: 500, enabled: !0, fn: function (e, t) {
                    ...
                    var r = e.placement.split("-")[0], o = e.offsets, s = o.popper, a = o.reference,
                        ...
                        f = c.toLowerCase(), d = l ? "left" : "top", h = l ? "bottom" : "right", p = tt(i)[u];
                    a[h] - p < s[f] && (e.offsets.popper[f] -= s[f] - (a[h] - p)), a[f] + p > s[h] && (e.offsets.popper[f] += a[f] + p - s[h]), e.offsets.popper = Ke(e.offsets.popper);
                    var g = a[f] + a[u] / 2 - p / 2, m = ke(e.instance.popper), v = parseFloat(m["margin" + c], 10),
                        y = parseFloat(m["border" + c + "Width"], 10), b = g - e.offsets.popper[f] - v - y;
                    return b = Math.max(Math.min(s[u] - p, b), 0), e.arrowElement = i, e.offsets.arrow = (Ve(n = {}, f, Math.round(b)), Ve(n, d, ""), n), e
                }, element: "[x-arrow]"
            }, flip: {
                order: 600,
                enabled: !0,
                fn: function (m, v) {
                    if (st(m.instance.modifiers, "inner")) return m;
                    if (m.flipped && m.placement === m.originalPlacement) return m;
                    var y = Je(m.instance.popper, m.instance.reference, v.padding, v.boundariesElement, m.positionFixed),
                        b = m.placement.split("-")[0], _ = nt(b), w = m.placement.split("-")[1] || "", E = [];
                    switch (v.behavior) {
                        case yt:
                            E = [b, _];
                            break;
                    ...
                    return E.forEach(function (e, t) {
                        if (b !== e || E.length === t + 1) return m;
                        b = m.placement.split("-")[0], _ = nt(b);
                        var n, i = m.offsets.popper, r = m.offsets.reference, o = Math.floor,
                            s = "left" === b && o(i.right) > o(r.left) || "right" === b && o(i.left) < o(r.right) || "top" === b && o(i.bottom) > o(r.top) || "bottom" === b && o(i.top) < o(r.bottom),
                            a = o(i.left) < o(y.left), l = o(i.right) > o(y.right), u = o(i.top) < o(y.top),
                            ...
                            g = h || p;
                        (s || f || g) && (m.flipped = !0, (s || f) && (b = E[t + 1]), g && (w = "end" === (n = w) ? "start" : "start" === n ? "end" : n), m.placement = b + (w ? "-" + w : ""), m.offsets.popper = $e({}, m.offsets.popper, it(m.instance.popper, m.offsets.reference, m.placement)), m = ot(m.instance.modifiers, m, "flip"))
                    }), m
                },
                behavior: "flip",
                padding: 5,
                ...
                order: 700, enabled: !1, fn: function (e) {
                    ...
                    return r[s ? "left" : "top"] = o[n] - (a ? r[s ? "width" : "height"] : 0), e.placement = nt(t), e.offsets.popper = Ke(r), e
                }
            }, hide: {
                ...
                order: 850, enabled: !0, fn: function (e, t) {
                    var n = t.x, i = t.y, r = e.offsets.popper, o = rt(e.instance.modifiers, function (e) {
                        return "applyStyle" === e.name
                    }).gpuAcceleration;
                    void 0 !== o && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                    var s, a, l, u, c, f, d, h, p, g, m, v, y, b, _ = void 0 !== o ? o : t.gpuAcceleration,
                        w = qe(e.instance.popper), E = Ye(w), T = {position: r.position},
                        x = (s = e, a = window.devicePixelRatio < 2 || !ht, l = s.offsets, u = l.popper, c = l.reference, f = Math.round, d = Math.floor, h = function (e) {
                            return e
                        ...
                        A = at("transform"), D = void 0, N = void 0;
        ...
        function o(e, t) {
            ...
            }, this.update = Ne(this.update.bind(this)), this.options = $e({}, o.Defaults, i), this.state = {
                isDestroyed: !1,
                isCreated: !1,
                scrollParents: []
    ...
    Tt.Utils = ("undefined" != typeof window ? window : global).PopperUtils, Tt.placements = gt, Tt.Defaults = Et;
    var xt = "dropdown", Ct = "bs.dropdown", St = "." + Ct, At = ".data-api", Dt = p.fn[xt],
        Nt = new RegExp("38|40|27"), It = {
            HIDE: "hide" + St,
            HIDDEN: "hidden" + St,
            SHOW: "show" + St,
            SHOWN: "shown" + St,
        ...
        }, kt = "disabled", Ot = "show", Lt = "dropup", jt = "dropright", Ht = "dropleft", Pt = "dropdown-menu-right",
        Rt = "position-static", qt = '[data-toggle="dropdown"]', Mt = ".dropdown form", Wt = ".dropdown-menu",
        Ft = ".navbar-nav", Bt = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", Ut = "top-start",
        zt = "top-end", Qt = "bottom-start", Vt = "bottom-end", $t = "right-start", Kt = "left-start", Yt = {
            offset: 0,
            flip: !0,
            ...
            var e = u.prototype;
            return e.toggle = function () {
                if (!this._element.disabled && !p(this._element).hasClass(kt)) {
                    var e = p(this._menu).hasClass(Ot);
                    u._clearMenus(), e || this.show(!0)
                }
            }, e.show = function (e) {
                if (void 0 === e && (e = !1), !(this._element.disabled || p(this._element).hasClass(kt) || p(this._menu).hasClass(Ot))) {
                    var t = {relatedTarget: this._element}, n = p.Event(It.SHOW, t),
                        i = u._getParentFromElement(this._element);
                    if (p(i).trigger(n), !n.isDefaultPrevented()) {
                        if (!this._inNavbar && e) {
                            if (void 0 === Tt) throw new TypeError("Bootstrap's dropdowns require Popper.js (https://popper.js.org/)");
                            var r = this._element;
                            "parent" === this._config.reference ? r = i : g.isElement(this._config.reference) && (r = this._config.reference, void 0 !== this._config.reference.jquery && (r = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(i).addClass(Rt), this._popper = new Tt(r, this._menu, this._getPopperConfig())
                        }
                        "ontouchstart" in document.documentElement && 0 === p(i).closest(Ft).length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(Ot), p(i).toggleClass(Ot).trigger(p.Event(It.SHOWN, t))
                    }
                }
            }, e.hide = function () {
                if (!this._element.disabled && !p(this._element).hasClass(kt) && p(this._menu).hasClass(Ot)) {
                    var e = {relatedTarget: this._element}, t = p.Event(It.HIDE, e),
                        n = u._getParentFromElement(this._element);
                    p(n).trigger(t), t.isDefaultPrevented() || (this._popper && this._popper.destroy(), p(this._menu).toggleClass(Ot), p(n).toggleClass(Ot).trigger(p.Event(It.HIDDEN, e)))
                }
            }, e.dispose = function () {
                ...
                var t = this;
                p(this._element).on(It.CLICK, function (e) {
                    e.preventDefault(), e.stopPropagation(), t.toggle()
                })
            }, e._getConfig = function (e) {
                return e = l({}, this.constructor.Default, {}, p(this._element).data(), {}, e), g.typeCheckConfig(xt, e, this.constructor.DefaultType), e
                ...
                var e = p(this._element.parentNode), t = Qt;
                return e.hasClass(Lt) ? (t = Ut, p(this._menu).hasClass(Pt) && (t = zt)) : e.hasClass(jt) ? t = $t : e.hasClass(Ht) ? t = Kt : p(this._menu).hasClass(Pt) && (t = Vt), t
                ...
                if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which)) for (var t = [].slice.call(document.querySelectorAll(qt)), n = 0, i = t.length; n < i; n++) {
                    var r = u._getParentFromElement(t[n]), o = p(t[n]).data(Ct), s = {relatedTarget: t[n]};
                    if (e && "click" === e.type && (s.clickEvent = e), o) {
                        var a = o._menu;
                        if (p(r).hasClass(Ot) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && p.contains(r, e.target))) {
                            var l = p.Event(It.HIDE, s);
                            p(r).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), t[n].setAttribute("aria-expanded", "false"), o._popper && o._popper.destroy(), p(a).removeClass(Ot), p(r).removeClass(Ot).trigger(p.Event(It.HIDDEN, s)))
                        }
                    }
                }
                ...
                if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(Wt).length)) : Nt.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !p(this).hasClass(kt))) {
                    var t = u._getParentFromElement(this), n = p(t).hasClass(Ot);
                    if (n || 27 !== e.which) if (n && (!n || 27 !== e.which && 32 !== e.which)) {
                        var i = [].slice.call(t.querySelectorAll(Bt)).filter(function (e) {
    ...
    p(document).on(It.KEYDOWN_DATA_API, qt, Gt._dataApiKeydownHandler).on(It.KEYDOWN_DATA_API, Wt, Gt._dataApiKeydownHandler).on(It.CLICK_DATA_API + " " + It.KEYUP_DATA_API, Gt._clearMenus).on(It.CLICK_DATA_API, qt, function (e) {
        e.preventDefault(), e.stopPropagation(), Gt._jQueryInterface.call(p(this), "toggle")
    }).on(It.CLICK_DATA_API, Mt, function (e) {
        e.stopPropagation()
    }), p.fn[xt] = Gt._jQueryInterface, p.fn[xt].Constructor = Gt, p.fn[xt].noConflict = function () {
        return p.fn[xt] = Dt, Gt._jQueryInterface
    };
    var Jt = "modal", Zt = "bs.modal", en = "." + Zt, tn = p.fn[Jt],
        nn = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
        rn = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, on = {
            HIDE: "hide" + en,
            HIDE_PREVENTED: "hidePrevented" + en,
            HIDDEN: "hidden" + en,
            SHOW: "show" + en,
            SHOWN: "shown" + en,
            FOCUSIN: "focusin" + en,
        ...
        }, sn = "modal-dialog-scrollable", an = "modal-scrollbar-measure", ln = "modal-backdrop", un = "modal-open",
        cn = "fade", fn = "show", dn = "modal-static", hn = ".modal-dialog", pn = ".modal-body",
        gn = '[data-toggle="modal"]', mn = '[data-dismiss="modal"]',
        vn = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", yn = ".sticky-top", bn = function () {
            function r(e, t) {
                this._config = this._getConfig(t), this._element = e, this._dialog = e.querySelector(hn), this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollbarWidth = 0
            }
            ...
            return e.toggle = function (e) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    p(this._element).hasClass(cn) && (this._isTransitioning = !0);
                    var n = p.Event(on.SHOW, {relatedTarget: e});
                    p(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(on.CLICK_DISMISS, mn, function (e) {
                        return t.hide(e)
                    }), p(this._dialog).on(on.MOUSEDOWN_DISMISS, function () {
                        p(t._element).one(on.MOUSEUP_DISMISS, function (e) {
                ...
                if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
                    var n = p.Event(on.HIDE);
                    if (p(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                        this._isShown = !1;
                        var i = p(this._element).hasClass(cn);
                        if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), p(document).off(on.FOCUSIN), p(this._element).removeClass(fn), p(this._element).off(on.CLICK_DISMISS), p(this._dialog).off(on.MOUSEDOWN_DISMISS), i) {
                ...
                [window, this._element, this._dialog].forEach(function (e) {
                    return p(e).off(en)
                }), p(document).off(on.FOCUSIN), p.removeData(this._element, Zt), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
            }, e.handleUpdate = function () {
                this._adjustDialog()
            }, e._getConfig = function (e) {
                return e = l({}, nn, {}, e), g.typeCheckConfig(Jt, e, rn), e
            }, e._triggerBackdropTransition = function () {
                var e = this;
                if ("static" === this._config.backdrop) {
                    var t = p.Event(on.HIDE_PREVENTED);
                ...
                var t = this, n = p(this._element).hasClass(cn), i = this._dialog ? this._dialog.querySelector(pn) : null;
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), p(this._dialog).hasClass(sn) && i ? i.scrollTop = 0 : this._element.scrollTop = 0, n && g.reflow(this._element), p(this._element).addClass(fn), this._config.focus && this._enforceFocus();
                var r = p.Event(on.SHOWN, {relatedTarget: e}), o = function () {
                ...
                var t = this;
                p(document).off(on.FOCUSIN).on(on.FOCUSIN, function (e) {
                    document !== e.target && t._element !== e.target && 0 === p(t._element).has(e.target).length && t._element.focus()
                })
            }, e._setEscapeEvent = function () {
                var t = this;
                this._isShown && this._config.keyboard ? p(this._element).on(on.KEYDOWN_DISMISS, function (e) {
                    27 === e.which && t._triggerBackdropTransition()
                }) : this._isShown || p(this._element).off(on.KEYDOWN_DISMISS)
            }, e._setResizeEvent = function () {
                var t = this;
                this._isShown ? p(window).on(on.RESIZE, function (e) {
                    return t.handleUpdate(e)
                }) : p(window).off(on.RESIZE)
            }, e._hideModal = function () {
                var e = this;
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function () {
                    p(document.body).removeClass(un), e._resetAdjustments(), e._resetScrollbar(), p(e._element).trigger(on.HIDDEN)
                })
            }, e._removeBackdrop = function () {
                this._backdrop && (p(this._backdrop).remove(), this._backdrop = null)
            }, e._showBackdrop = function (e) {
                var t = this, n = p(this._element).hasClass(cn) ? cn : "";
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = ln, n && this._backdrop.classList.add(n), p(this._backdrop).appendTo(document.body), p(this._element).on(on.CLICK_DISMISS, function (e) {
                        t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && t._triggerBackdropTransition()
                    }), n && g.reflow(this._backdrop), p(this._backdrop).addClass(fn), !e) return;
                    if (!n) return void e();
                    var i = g.getTransitionDurationFromElement(this._backdrop);
                    p(this._backdrop).one(g.TRANSITION_END, e).emulateTransitionEnd(i)
                } else if (!this._isShown && this._backdrop) {
                    p(this._backdrop).removeClass(fn);
                    var r = function () {
                        t._removeBackdrop(), e && e()
                    };
                    if (p(this._element).hasClass(cn)) {
                ...
                if (this._isBodyOverflowing) {
                    var e = [].slice.call(document.querySelectorAll(vn)), t = [].slice.call(document.querySelectorAll(yn));
                ...
                e.className = an, document.body.appendChild(e);
                var t = e.getBoundingClientRect().width - e.clientWidth;
                return document.body.removeChild(e), t
            }, r._jQueryInterface = function (n, i) {
                return this.each(function () {
                    var e = p(this).data(Zt), t = l({}, nn, {}, p(this).data(), {}, "object" == typeof n && n ? n : {});
                    if (e || (e = new r(this, t), p(this).data(Zt, e)), "string" == typeof n) {
                        if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                        e[n](i)
    ...
    p(document).on(on.CLICK_DATA_API, gn, function (e) {
        var t, n = this, i = g.getSelectorFromElement(this);
        i && (t = document.querySelector(i));
        var r = p(t).data(Zt) ? "toggle" : l({}, p(t).data(), {}, p(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
        var o = p(t).one(on.SHOW, function (e) {
            e.isDefaultPrevented() || o.one(on.HIDDEN, function () {
                p(n).is(":visible") && n.focus()
            })
        });
        bn._jQueryInterface.call(p(t), r, this)
    }), p.fn[Jt] = bn._jQueryInterface, p.fn[Jt].Constructor = bn, p.fn[Jt].noConflict = function () {
        return p.fn[Jt] = tn, bn._jQueryInterface
    };
    var _n = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"], wn = {
        ...
        for (var n = (new window.DOMParser).parseFromString(e, "text/html"), a = Object.keys(s), l = [].slice.call(n.body.querySelectorAll("*")), i = function (e, t) {
            ...
            r.forEach(function (e) {
                (function (e, t) {
                    ...
                    if (-1 !== t.indexOf(n)) return -1 === _n.indexOf(n) || Boolean(e.nodeValue.match(En) || e.nodeValue.match(Tn));
    ...
    var Cn = "tooltip", Sn = "bs.tooltip", An = "." + Sn, Dn = p.fn[Cn], Nn = "bs-tooltip",
        In = new RegExp("(^|\\s)" + Nn + "\\S+", "g"), kn = ["sanitize", "whiteList", "sanitizeFn"], On = {
            animation: "boolean",
            template: "string",
            ...
            whiteList: "object",
            popperConfig: "(null|object)"
        }, Ln = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}, jn = {
            animation: !0,
        ...
        }, qn = "fade", Mn = "show", Wn = ".tooltip-inner", Fn = ".arrow", Bn = "hover", Un = "focus", zn = "click",
        Qn = "manual", Vn = function () {
            function i(e, t) {
                if (void 0 === Tt) throw new TypeError("Bootstrap's tooltips require Popper.js (https://popper.js.org/)");
            ...
            return e.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    r.setAttribute("id", o), this.element.setAttribute("aria-describedby", o), this.setContent(), this.config.animation && p(r).addClass(qn);
                    var s = "function" == typeof this.config.placement ? this.config.placement.call(this, r, this.element) : this.config.placement,
                        a = this._getAttachment(s);
                    this.addAttachmentClass(a);
                    var l = this._getContainer();
                    p(r).data(this.constructor.DATA_KEY, this), p.contains(this.element.ownerDocument.documentElement, this.tip) || p(r).appendTo(l), p(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new Tt(this.element, r, this._getPopperConfig(a)), p(r).addClass(Mn), "ontouchstart" in document.documentElement && p(document.body).children().on("mouseover", null, p.noop);
                    var u = function () {
                        t.config.animation && t._fixTransition();
                        var e = t._hoverState;
                        t._hoverState = null, p(t.element).trigger(t.constructor.Event.SHOWN), e === Pn && t._leave(null, t)
                    };
                    if (p(this.tip).hasClass(qn)) {
                ...
                var t = this, n = this.getTipElement(), i = p.Event(this.constructor.Event.HIDE), r = function () {
                    t._hoverState !== Hn && n.parentNode && n.parentNode.removeChild(n), t._cleanTipClass(), t.element.removeAttribute("aria-describedby"), p(t.element).trigger(t.constructor.Event.HIDDEN), null !== t._popper && t._popper.destroy(), e && e()
                };
                if (p(this.element).trigger(i), !i.isDefaultPrevented()) {
                    if (p(n).removeClass(Mn), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger[zn] = !1, this._activeTrigger[Un] = !1, this._activeTrigger[Bn] = !1, p(this.tip).hasClass(qn)) {
                ...
                this.setElementContent(p(e.querySelectorAll(Wn)), this.getTitle()), p(e).removeClass(qn + " " + Mn)
                ...
                this.config.trigger.split(" ").forEach(function (e) {
                    if ("click" === e) p(i.element).on(i.constructor.Event.CLICK, i.config.selector, function (e) {
                        ...
                        var t = e === Bn ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
                            n = e === Bn ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT;
                ...
                (t = t || p(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusin" === e.type ? Un : Bn] = !0), p(t.getTipElement()).hasClass(Mn) || t._hoverState === Hn ? t._hoverState = Hn : (clearTimeout(t._timeout), t._hoverState = Hn, t.config.delay && t.config.delay.show ? t._timeout = setTimeout(function () {
                    t._hoverState === Hn && t.show()
                }, t.config.delay.show) : t.show())
            }, e._leave = function (e, t) {
                var n = this.constructor.DATA_KEY;
                (t = t || p(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusout" === e.type ? Un : Bn] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = Pn, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function () {
                ...
                return Object.keys(t).forEach(function (e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), g.typeCheckConfig(Cn, e, this.constructor.DefaultType), e.sanitize && (e.template = xn(e.template, e.whiteList, e.sanitizeFn)), e
            }, e._getDelegateConfig = function () {
                var e = {};
                if (this.config) for (var t in this.config) this.constructor.Default[t] !== this.config[t] && (e[t] = this.config[t]);
                return e
            }, e._cleanTipClass = function () {
                var e = p(this.getTipElement()), t = e.attr("class").match(In);
                ...
                null === e.getAttribute("x-placement") && (p(e).removeClass(qn), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
            }, i._jQueryInterface = function (n) {
                return this.each(function () {
    ...
    p.fn[Cn] = Vn._jQueryInterface, p.fn[Cn].Constructor = Vn, p.fn[Cn].noConflict = function () {
        return p.fn[Cn] = Dn, Vn._jQueryInterface
    };
    var $n = "popover", Kn = "bs.popover", Yn = "." + Kn, Xn = p.fn[$n], Gn = "bs-popover",
        Jn = new RegExp("(^|\\s)" + Gn + "\\S+", "g"), Zn = l({}, Vn.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        }), ei = l({}, Vn.DefaultType, {content: "(string|element|function)"}), ti = "fade", ni = "show",
        ii = ".popover-header", ri = ".popover-body", oi = {
            ...
            return r.isWithContent = function () {
                ...
                var e = p(this.getTipElement()), t = e.attr("class").match(Jn);
                null !== t && 0 < t.length && e.removeClass(t.join(""))
            }, i._jQueryInterface = function (n) {
                return this.each(function () {
                    var e = p(this).data(Kn), t = "object" == typeof n ? n : null;
    ...
    p.fn[$n] = si._jQueryInterface, p.fn[$n].Constructor = si, p.fn[$n].noConflict = function () {
        return p.fn[$n] = Xn, si._jQueryInterface
    };
    var ai = "scrollspy", li = "bs.scrollspy", ui = "." + li, ci = p.fn[ai],
        fi = {offset: 10, method: "auto", target: ""},
        di = {offset: "number", method: "string", target: "(string|element)"},
        hi = {ACTIVATE: "activate" + ui, SCROLL: "scroll" + ui, LOAD_DATA_API: "load" + ui + ".data-api"},
        pi = "dropdown-item", gi = "active", mi = '[data-spy="scroll"]', vi = ".nav, .list-group", yi = ".nav-link",
        bi = ".nav-item", _i = ".list-group-item", wi = ".dropdown", Ei = ".dropdown-item", Ti = ".dropdown-toggle",
        xi = "offset", Ci = "position", Si = function () {
            function n(e, t) {
                var n = this;
                this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(t), this._selector = this._config.target + " " + yi + "," + this._config.target + " " + _i + "," + this._config.target + " " + Ei, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(hi.SCROLL, function (e) {
                    return n._process(e)
            ...
            return e.refresh = function () {
                var t = this, e = this._scrollElement === this._scrollElement.window ? xi : Ci,
                    r = "auto" === this._config.method ? e : this._config.method, o = r === Ci ? this._getScrollTop() : 0;
                ...
                p.removeData(this._element, li), p(this._scrollElement).off(ui), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, e._getConfig = function (e) {
                if ("string" != typeof (e = l({}, fi, {}, "object" == typeof e && e ? e : {})).target) {
                ...
                n.hasClass(pi) ? (n.closest(wi).find(Ti).addClass(gi), n.addClass(gi)) : (n.addClass(gi), n.parents(vi).prev(yi + ", " + _i).addClass(gi), n.parents(vi).prev(bi).children(yi).addClass(gi)), p(this._scrollElement).trigger(hi.ACTIVATE, {relatedTarget: t})
            }, e._clear = function () {
    ...
    p(window).on(hi.LOAD_DATA_API, function () {
        ...
        return p.fn[ai] = ci, Si._jQueryInterface
    };
    var Ai = "bs.tab", Di = "." + Ai, Ni = p.fn.tab, Ii = {
            HIDE: "hide" + Di,
            HIDDEN: "hidden" + Di,
            SHOW: "show" + Di,
            SHOWN: "shown" + Di,
            CLICK_DATA_API: "click" + Di + ".data-api"
        }, ki = "dropdown-menu", Oi = "active", Li = "disabled", ji = "fade", Hi = "show", Pi = ".dropdown",
        Ri = ".nav, .list-group", qi = ".active", Mi = "> li > .active",
        Wi = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', Fi = ".dropdown-toggle",
        Bi = "> .dropdown-menu .active", Ui = function () {
            function i(e) {
                this._element = e
            }
            ...
            return e.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Oi) || p(this._element).hasClass(Li))) {
                    var e, i, t = p(this._element).closest(Ri)[0], r = g.getSelectorFromElement(this._element);
                    if (t) {
                        var o = "UL" === t.nodeName || "OL" === t.nodeName ? Mi : qi;
                    ...
                    if (i && p(i).trigger(s), p(this._element).trigger(a), !a.isDefaultPrevented() && !s.isDefaultPrevented()) {
                        ...
                        var l = function () {
                            var e = p.Event(Ii.HIDDEN, {relatedTarget: n._element}),
                                t = p.Event(Ii.SHOWN, {relatedTarget: i});
                ...
                p.removeData(this._element, Ai), this._element = null
            }, e._activate = function (e, t, n) {
                var i = this, r = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? p(t).children(qi) : p(t).find(Mi))[0],
                    o = n && r && p(r).hasClass(ji), s = function () {
                        return i._transitionComplete(e, r, n)
                    };
                if (r && o) {
                    var a = g.getTransitionDurationFromElement(r);
                    p(r).removeClass(Hi).one(g.TRANSITION_END, s).emulateTransitionEnd(a)
                } else s()
            }, e._transitionComplete = function (e, t, n) {
                if (t) {
                    p(t).removeClass(Oi);
                    var i = p(t.parentNode).find(Bi)[0];
                    i && p(i).removeClass(Oi), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
                }
                if (p(e).addClass(Oi), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), g.reflow(e), e.classList.contains(ji) && e.classList.add(Hi), e.parentNode && p(e.parentNode).hasClass(ki)) {
                    var r = p(e).closest(Pi)[0];
                    if (r) {
                        var o = [].slice.call(r.querySelectorAll(Fi));
                        p(o).addClass(Oi)
                    }
                ...
                return this.each(function () {
                    var e = p(this), t = e.data(Ai);
                    if (t || (t = new i(this), e.data(Ai, t)), "string" == typeof n) {
    ...
    p(document).on(Ii.CLICK_DATA_API, Wi, function (e) {
        e.preventDefault(), Ui._jQueryInterface.call(p(this), "show")
    }), p.fn.tab = Ui._jQueryInterface, p.fn.tab.Constructor = Ui, p.fn.tab.noConflict = function () {
        return p.fn.tab = Ni, Ui._jQueryInterface
    };
    var zi = "toast", Qi = "bs.toast", Vi = "." + Qi, $i = p.fn[zi], Ki = {
            CLICK_DISMISS: "click.dismiss" + Vi,
            HIDE: "hide" + Vi,
            HIDDEN: "hidden" + Vi,
            SHOW: "show" + Vi,
            SHOWN: "shown" + Vi
        }, Yi = "fade", Xi = "hide", Gi = "show", Ji = "showing",
        ...
        er = {animation: !0, autohide: !0, delay: 500}, tr = '[data-dismiss="toast"]', nr = function () {
            ...
            var e = i.prototype;
            return e.show = function () {
                var e = this, t = p.Event(Ki.SHOW);
                if (p(this._element).trigger(t), !t.isDefaultPrevented()) {
                    this._config.animation && this._element.classList.add(Yi);
                    var n = function () {
                        e._element.classList.remove(Ji), e._element.classList.add(Gi), p(e._element).trigger(Ki.SHOWN), e._config.autohide && (e._timeout = setTimeout(function () {
                            e.hide()
                        }, e._config.delay))
                    };
                    if (this._element.classList.remove(Xi), g.reflow(this._element), this._element.classList.add(Ji), this._config.animation) {
                ...
                if (this._element.classList.contains(Gi)) {
                    var e = p.Event(Ki.HIDE);
                    p(this._element).trigger(e), e.isDefaultPrevented() || this._close()
                }
            }, e.dispose = function () {
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Gi) && this._element.classList.remove(Gi), p(this._element).off(Ki.CLICK_DISMISS), p.removeData(this._element, Qi), this._element = null, this._config = null
            }, e._getConfig = function (e) {
                return e = l({}, er, {}, p(this._element).data(), {}, "object" == typeof e && e ? e : {}), g.typeCheckConfig(zi, e, this.constructor.DefaultType), e
            }, e._setListeners = function () {
                var e = this;
                p(this._element).on(Ki.CLICK_DISMISS, tr, function () {
                    return e.hide()
                })
            }, e._close = function () {
                var e = this, t = function () {
                    e._element.classList.add(Xi), p(e._element).trigger(Ki.HIDDEN)
                };
                ...
                return this.each(function () {
                    var e = p(this), t = e.data(Qi);
                    if (t || (t = new i(this, "object" == typeof n && n), e.data(Qi, t)), "string" == typeof n) {
                        if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                        t[n](this)
                    }
                })
    ...
    p.fn[zi] = nr._jQueryInterface, p.fn[zi].Constructor = nr, p.fn[zi].noConflict = function () {
        return p.fn[zi] = $i, nr._jQueryInterface
    }, e.Alert = v, e.Button = j, e.Carousel = ce, e.Collapse = Se, e.Dropdown = Gt, e.Modal = bn, e.Popover = si, e.Scrollspy = Si, e.Tab = Ui, e.Toast = nr, e.Tooltip = Vn, e.Util = g, Object.defineProperty(e, "__esModule", {value: !0})
}), function (D) {
    D.fn.extend({
