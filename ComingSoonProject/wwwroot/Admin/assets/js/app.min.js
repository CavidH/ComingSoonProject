!function (n) {
    ...
    t.prototype.init = function () {
        ...
        o(document).on("click", this.$portletCloser, function (t) {
            t.preventDefault();
            var e = o(this).closest(a.$portletIdentifier), i = e.parent();
    ...
    "use strict";
    var t = function () {
        this.$bootstrapStylesheet = e("#bootstrap-stylesheet"), this.$appStylesheet = e("#app-stylesheet"), this.$originalBSStylesheet = e("#bootstrap-stylesheet").attr("href"), this.$originalAppStylesheet = e("#app-stylesheet").attr("href")
    };
    t.prototype.init = function () {
        var t = this;
    ...
    }, e.RightSidebar = new t, e.RightSidebar.Constructor = t
    ...
    t.prototype._resetSidebarScroll = function () {
        ...
        }), i("#side-menu").metisMenu(), e._resetSidebarScroll(), i(".right-bar-toggle").on("click", function (t) {
            i("body").toggleClass("right-bar-enabled")
        }), i(document).on("click", "body", function (t) {
            0 < i(t.target).closest(".right-bar-toggle, .right-bar").length || 0 < i(t.target).closest(".left-side-menu, .side-nav").length || i(t.target).hasClass("button-menu-mobile") || 0 < i(t.target).closest(".button-menu-mobile").length || (i("body").removeClass("right-bar-enabled"), i("body").removeClass("sidebar-enable"))
        }), i("#side-menu a").each(function () {
            var t = window.location.href.split(/[?#]/)[0];
            this.href == t && (i(this).addClass("active"), i(this).parent().addClass("mm-active"), i(this).parent().parent().addClass("mm-show"), i(this).parent().parent().prev().addClass("active"), i(this).parent().parent().parent().addClass("mm-active"), i(this).parent().parent().parent().parent().addClass("mm-show"), i(this).parent().parent().parent().parent().parent().addClass("mm-active"))
        ...
        var e = this;
        this.initLayout(), i.Portlet.init(), this.initMenu(), i.Components.init(), i.RightSidebar.init(), e.$window.on("resize", function (t) {
